...
export default class Category extends Component {
    ...
    //异步获取一级分类列表显示
    //parentId:没有指定根据状态中的parentId请求，如果指定了根据指定的请求
    ...
    showSubCategorys = (category) => {
        ...
        //  setState()  不能立即获取最新的状态，setState()是异步更新状态
    ...
    render() {
        ...
        //读取指定的分类，如果还没有指定一个空对象
        const category = this.category || {}
        //card左边
        const title = parentId === '0' ? '一级分类列表' : (
            <span>
                <LinkButton onClick={this.showSubCategorys}>一级分类列表</LinkButton>
